...
\chapter{ARPA vs OSI}
\input{src/arpa-model}
\input{src/arpaosi}

\chapter{IP}
\input{src/ip-address}
\section{De envelope}
\input{src/ip4_packet}
...
\input{src/default_gateway}
\section{Routing Protocollen}
\input{src/routingprotocollen}

\chapter{Opdrachten}
\section{Speciale IP adressen}
\input{src/opdracht_speciale_addr}
\section{IP configuratie}
\input{src/opdracht_config}
\section{ping}
\input{src/opdracht_ping}
\section{traceroute}
\input{src/opdracht_traceroute}
