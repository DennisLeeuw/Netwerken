...
\input{src/dhcp-protocol}
\section{Lease time}
\input{src/lease_time}
\section{DHCP Options}
\input{src/dhcp-options}
...
\input{src/option-subnetmask}
\section{Option: routers}
\input{src/option-routers}
\section{Option: domain-name}
\input{src/option-domainname}
\section{Option: domain-name-servers}
\input{src/option-domainnameservers}

\chapter{Een dynamisch vast IP-adres}
\input{src/fixed_ip}
\section{Option host-name}
\input{src/option-hostname}

\chapter{Opdrachten}
\section{DHCP-server op Windows}
\input{src/opdracht_dhcp-win-installatie}
